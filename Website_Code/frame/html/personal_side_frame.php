<aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li>
                            <a class="waves-effect waves-dark" href="/personal/index.php" aria-expanded="false">
                                <i class="mdi mdi-account-circle"></i><span class="hide-menu">个人中心</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="/personal/info.php" aria-expanded="false">
                                <i class="mdi mdi-account-edit"></i><span class="hide-menu">信息修改</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="/personal/work.php" aria-expanded="false">
                                <i class="mdi mdi-wunderlist"></i><span class="hide-menu">岗位信息</span>
                            </a>
                        </li>
            ...
            <div class="sidebar-footer">
                ...
                <!-- item--><a href="/log/logout.php" class="link" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
            </div>
            <!-- End Bottom points-->
</aside>
