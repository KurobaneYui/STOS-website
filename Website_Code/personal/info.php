                                ...
                                <form class="form-horizontal form-material needs-validation" id="myform" novalidate action="info.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="Name" placeholder="" name="姓名" <?php echo("value={$person->xinming}"); ?> required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 custom-control custom-radi" id="gender">
                                            <input class="form-control" id="man" name="性别" value="男" type="radio" <?php if($person->xinbie=="男")echo("checked"); ?> required>
                                            <label class="custom-control-label" for="man">男</label>
                                        </div>
                                        <div class="col-md-12 custom-control custom-radi">
                                            <input class="form-control" id="woman" name="性别" value="女" type="radio" <?php if($person->xinbie=="女")echo("checked"); ?> required>
