                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/personal/work.php" aria-expanded="false"><i class="mdi mdi-wunderlist"></i><span class="hide-menu">岗位信息</span></a>
                          ...
                          <!--组员附加页-->
                            ...
                            <hr/>
                            <li> <a class="waves-effect waves-dark" href="/personal/team_leader/upload_file.html" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">上传文件</span></a></li>
                            <li> <a class="waves-effect waves-dark" href="/list_files.php" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">下载文件</span></a></li>
                            <?php if($person->work_info()["权限"]!=3) echo("-->"); ?>
                            ...
                            <!--早餐组附加页-->
                            <?php if($person->work_info()["所属组"]!="早餐组") echo("<!--"); ?>
                            <li> <a class="waves-effect waves-dark" href="/personal/group_member/ZaoCanData.php" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">早餐组数据提交</span></a></li>
                            <?php if($person->work_info()["所属组"]!="早餐组") echo("-->"); ?>
						
							<!--骨干附加页-->
                            <?php if($person->work_info()["权限"]<=1) echo("<!--"); ?>
							<hr/>
                            <li> <a class="waves-effect waves-dark" href="/personal/group_leader/member_decrease.php" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">老组员离岗</span></a></li>
							<li> <a class="waves-effect waves-dark" href="/personal/group_leader/member_increase.php" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">新组员到岗</span></a></li>
                            <?php if($person->work_info()["权限"]<=1) echo("-->"); ?>
                    </ul>
