...
async function register() {
    ...
    const register_info = {
        ...
        dormitory_dong: String(form.value.dormitory_dong),
        dormitory_hao: String(form.value.dormitory_hao),
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-check col-2 offset-1">
                                    ...
                                    <input type="radio" class="form-check-input" id="gender_male" name="gender"
                                        value="male" v-model="form.value.gender" />
                                </div>
                                <div class="form-check col-2">
                                    ...
                                    <input type="radio" class="form-check-input" id="gender_female" name="gender"
                                        value="female" v-model="form.value.gender" />
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ethnicity" name="ethnicity" placeholder="请输入民族"
                                aria-describedby="ethnicityHelp" required v-model="form.value.ethnicity" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="hometown" name="hometown" placeholder="请输入籍贯"
                                required v-model="form.value.hometown" />
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="campus" class="form-select" required v-model="form.value.campus">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="school" class="form-select" required v-model="form.value.school">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="dormitory" class="input-group">
                                <select id="dormitory_yuan" class="form-control" aria-describedby="dormitoryHelp"
                                    required v-model="form.value.dormitory_yuan">
                                ...
                                <input id="dormitory_dong" type="number" class="form-control" min="1" max="99"
                                    placeholder="楼栋" aria-label="dong" required v-model="form.value.dormitory_dong" />
                                <span class="input-group-text">栋</span>
                                <input id="dormitory_hao" type="number" class="form-control" min="1" max="999"
                                    placeholder="宿舍号" aria-label="hao" required v-model="form.value.dormitory_hao" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bank" name="bank" placeholder="请输入银行卡号"
                                        aria-describedby="bankHelp" required v-model="form.value.bank" />
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="subsidyDossier"
                                            ...
                                            v-model="form.value.subsidyDossier" />
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                                                @click="form.value.claimBox = true">已知晓
                                            </button>
                                        </div>
                                    </div>
                                </div>
