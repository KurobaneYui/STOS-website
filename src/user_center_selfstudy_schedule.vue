...
const shaheList = ref([])
const unassignedList = ref([]) // New ref for unassigned members
...
// 提交按钮点击事件 (Corrected data mapping)
function onSubmitClick() {
    ...
    // 按照接口格式组合数据, using the correct property names
    const postData = {
        date: currentDate.value,
        data: {
            qingshuihe: qingshuiheList.value.map(item => ({
                selfstudy_id: item.schedule_id, // Use schedule_id from response
                student_id: item.student_id   // Use student_id from response
            })),
...
// 重置校区排班
async function resetMember(campus) {
    if (!currentDate.value) {
    ...
    try {
        const { data } = await axios.post('/Ajax/DataManager/reset_schedule_on_date', {
            date: currentDate.value,
            campus: campus
        })
        if (data.code === 200) {
                ...
                <div class="content-wrapper">
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="alert alert-primary" role="alert">
                            ...
                            * 有排班的日期，点击"重置"按钮会重导此日期已有排班<br />
                            * 对没有排班的日期，点击"重置"按钮会导入早于此日期最近一次的排班<br />
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-2 mb-3 flex-wrap align-items-center">
                                    ...
                                    <div class="form-check form-switch ms-3">
                                        <label for="draggableButton2" class="form-check-label">禁止拖动</label>
                                ...
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-sm btn-primary rounded-pill"
                                                :disabled="!isEditMode" @click="resetMember('沙河')">重置</button>
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <VueDraggable v-model="shaheList" :animation="150"
                                ...
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-sm btn-primary rounded-pill"
                                                :disabled="!isEditMode" @click="resetMember('清水河')">重置</button>
                                            <button type="button" class="btn btn-sm btn-primary rounded-pill ms-2"
                                                :disabled="!isEditMode" @click="randomMember('清水河')">随机</button>
                                        </div>
                                    </div>
                                    <div class="table-responsive text-nowrap">
                                        <VueDraggable v-model="qingshuiheList" :animation="150"
                                            :disabled="draggable_disable || !isEditMode">
                                            <table class="table table-hover table-striped mb-3 text-center">
                                                <thead>
                                                    <tr>
                                ...
                                <div v-if="unassignedList.length > 0">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
