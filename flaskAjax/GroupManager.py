...
def GroupManager(app: flask.Flask) -> None:
    ...
    #             # ========================
    #             # 检查接口输入参数并记录日志
    #             GroupManagerCheck.searchMemberParamsCheck(request)
    #             logger.funcArgs = request.form
    #             # =========================================
    #             # 执行接口流程，并获取用户名信息以完成会话建立
    #             results = GroupManagerDatabase.searchMember(
    #                 request)
    #             # ========================
    #             # 准备函数返回值和响应与日志
    #             returns = {"message": "",
    ...
    #             # ========================
    #             # 检查接口输入参数并记录日志
    #             GroupManagerCheck.addMemberParamsCheck(request)
    #             logger.funcArgs = request.form
    #             # =========================================
    #             # 执行接口流程，并获取用户名信息以完成会话建立
    #             GroupManagerDatabase.addMember(request)
    #             # ========================
    #             # 准备函数返回值和响应与日志
    ...
    #             # ========================
    #             # 检查接口输入参数并记录日志
    #             GroupManagerCheck.removeMemberParamsCheck(request)
    #             logger.funcArgs = request.form
    #             # =========================================
    #             # 执行接口流程，并获取用户名信息以完成会话建立
    #             GroupManagerDatabase.removeMember(request)
    #             # ========================
    #             # 准备函数返回值和响应与日志
    #             returns = {"message": "", "data": ""}
    #             customResponse.setMessageAndData(**returns)
    ...
    #             GroupManagerCheck.submitSelfstudyRecordRecheckParamsCheck(
    #                 infoForm)
    #             logger.funcArgs = request.form
    #             # ===========
    #             # 执行接口流程
    #             GroupManagerDatabase.submitSelfstudyRecordRecheck(
    #                 infoForm)
    #             # ========================
    #             # 准备函数返回值和响应与日志
    #             returns = {"message": "", "data": ""}
