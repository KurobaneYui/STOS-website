...
class GroupManagerCheck:
    ...
    #     if (
    #         "selfstudy_id" not in infoForm.keys()
    #         or "selfstudycheckdata_id" not in infoForm.keys()
    #         or "selfstudycheckabsent_id" not in infoForm.keys()
    ...
    #         infoForm["selfstudycheckdata_id"] = int(infoForm["selfstudycheckdata_id"])
