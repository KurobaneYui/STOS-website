                                    ...
                                    <div class="message-widget contact-widget">
                                        ...
                                        <a href="#">
                                            ...
                                            <div class="mail-contnet">
                                                <h5>备注1:</h5> <span class="mail-desc"><?php echo($person->work_info()["备注"]); ?></h6></span></div>
                                        </a>
                                        <!-- Message -->
                                        <a href="#">
                                            <!-- <div class="user-img"> <img src="./assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div> -->
                                            <div class="mail-contnet">
                                                <h5>备注2</h5> <span class="mail-desc"><?php echo($person->work_info()["备注"]); ?></h6></span></div>
                                        </a>
                                        <!-- Message -->
                                        <a href="#">
                                            <!-- <div class="user-img"> <span class="round">A</span> <span class="profile-status away pull-right"></span> </div> -->
                                            <div class="mail-contnet">
                                                <h5>备注3</h5> <span class="mail-desc"><?php echo($person->work_info()["备注"]); ?></h6></span></div>
                                        </a>
                                    </div>
                                </div>
                            </div>
